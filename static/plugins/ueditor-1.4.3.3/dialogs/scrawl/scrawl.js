...
(function () {
    ...
    scrawl.prototype = {
        ...
        originalState: function (options) {
            ...
            me.brushWidth = options.drawBrushSize;//同步畫笔粗细
            me.brushColor = options.drawBrushColor;//同步畫笔颜色

            context.lineWidth = me.brushWidth;//初始畫笔大小
            context.strokeStyle = me.brushColor;//初始畫笔颜色
            context.fillStyle = "transparent";//初始畫布背景颜色
        ...
        getCanvasData: function () {
            ...
            if (img) {
                ...
                context.fillStyle = "#fff";//重置畫布背景白色
