...
UE.I18N['zh-cn'] = {
  'labelMap': {
    ...
    'pasteplain': '纯文本粘贴模式', 'selectall': '全選', 'print': '打印', 'preview': '預覽',
  ...
  'wordOverFlowMsg': '<span style="color:red;">字數超出最大允許值，服務器可能拒绝保存！</span>',
  'ok': "確認",
  'cancel': "取消",
  'closeDialog': "關閉對話框",
  ...
  'insertimage': {
    ...
    'numError': "請输入正確的長度或者寬度值！例如：123，400",
    'imageUrlError': "不允許的圖片格式或者圖片域！",
    'imageLoadError': "圖片加載失败！請檢查鏈接地址或網路狀態！",
  ...
  'insertvideo': {
    'static': {
      ...
      'videoType': { 'options': ["全部", "熱門", "娱樂", "搞笑", "體育", "科技", "综藝"] },
    ...
    'flashLoadingError': 'Flash加載失败!請檢查路徑或網路狀態',
  ...
  'scrawl': {
    ...
    'continueBtn': "繼續",
    'imageError': "糟糕，圖片讀取失败了！",
    'backgroundUploading': '背景圖片上傳中,别急哦~'
  },
  'music': {
    'static': {
      'lang_input_tips': "输入歌手/歌曲/專辑，搜索您感兴趣的音樂！",
      'J_searchBtn': { value: '搜索歌曲' }
    },
    'emptyTxt': '未搜索到相關音樂結果，請換一個關键词試試。',
    'chapter': '歌曲',
    'singer': '歌手',
    'special': '專辑',
    'listenTest': '試听'
  ...
  'charts': {
    'static': {
      ...
      'lang_cahrt_tip_description': '僅餅圖有效， 當鼠標移動到餅圖中相應的塊上時，提示框内的文字的前缀',
  ...
  'help': {
    'static': {
      ...
      'lang_input_introduction': 'UEditor是由百度web前端研發部開發的所見即所得富文本web編輯器，具有轻量，可訂製，注重使用者體驗等特點。開源基於BSD協議，允許自由使用和修改程式碼。',
  ...
  'link': {
    ...
    'httpPrompt': '您输入的超鏈接中不包含http等協議名稱，默認將為您添加http://前缀'
  },
  'map': {
    'static': {
      lang_city: "城市",
  ...
  'wordimage': {
    'static': {
      ...
      lang_step: "1、點擊顶部複製按鈕，將地址複製到剪贴板；2、點擊添加照片按鈕，在彈出的對話框中使用Ctrl+V粘贴地址；3、點擊打開後選擇圖片上傳流程。"
    },
    'fileType': "圖片",
    'flashError': "FLASH初始化失败，請檢查FLASH插件是否正確安裝！",
    'netError': "網路連接錯誤，請重試！",
