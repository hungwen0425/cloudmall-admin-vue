    ...
    <div class="site-content__wrapper">
      <div class="site-content">
        <div class="brand-info">
          <h2 class="brand-info__text">cloudmall-admin-vue</h2>
          <p
            class="brand-info__intro"
          >cloudmall-admin-vue基於vue、element-ui構建開發，實現renren-fast後台管理前端功能，提供一套更優的前端解决方案。</p>
        </div>
        <div class="login-main">
          <h3 class="login-title">管理員登入</h3>
          <el-form
            :model="dataForm"
            :rules="dataRule"
            ref="dataForm"
          ...
          >
            ...
            <el-form-item prop="captcha">
              <el-row :gutter="20">
                <el-col :span="14">
                  <el-input v-model="dataForm.captcha" placeholder="驗證碼"></el-input>
                </el-col>
...
export default {
  data() {
    return {
      ...
      dataRule: {
        userName: [
          { required: true, message: "帐號不能為空", trigger: "blur" }
        ],
        password: [
