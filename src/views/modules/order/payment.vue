<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="orderSn" header-align="center" align="center" label="訂單號（對外業務號）"></el-table-column>
      <el-table-column prop="orderId" header-align="center" align="center" label="訂單id"></el-table-column>
      <el-table-column prop="alipayTradeNo" header-align="center" align="center" label="支付寶交易流水號"></el-table-column>
