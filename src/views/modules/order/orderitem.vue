<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="spuName" header-align="center" align="center" label="spu_name"></el-table-column>
      ...
      <el-table-column prop="skuId" header-align="center" align="center" label="商品sku編號"></el-table-column>
      ...
      <el-table-column prop="skuQuantity" header-align="center" align="center" label="商品購買的數量"></el-table-column>
      <el-table-column
        prop="skuAttrsVals"
        header-align="center"
        align="center"
      ...
      <el-table-column
        ...
        label="積分優惠分解金额"
      ></el-table-column>
      <el-table-column prop="realAmount" header-align="center" align="center" label="該商品經過優惠後的分解金额"></el-table-column>
