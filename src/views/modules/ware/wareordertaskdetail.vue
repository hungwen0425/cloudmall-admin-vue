<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="skuNum" header-align="center" align="center" label="购买個数"></el-table-column>
      <el-table-column prop="taskId" header-align="center" align="center" label="工作單id"></el-table-column>
