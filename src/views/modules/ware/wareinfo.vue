<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="name" header-align="center" align="center" label="倉庫名"></el-table-column>
      <el-table-column prop="address" header-align="center" align="center" label="倉庫地址"></el-table-column>
      <el-table-column prop="areaCode" header-align="center" align="center" label="區域編碼"></el-table-column>
