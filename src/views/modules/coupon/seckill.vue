<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="title" header-align="center" align="center" label="活动標题"></el-table-column>
      ...
      <el-table-column prop="status" header-align="center" align="center" label="上下线状态"></el-table-column>
      <el-table-column prop="createTime" header-align="center" align="center" label="创建时间"></el-table-column>
      <el-table-column prop="userId" header-align="center" align="center" label="创建人"></el-table-column>
