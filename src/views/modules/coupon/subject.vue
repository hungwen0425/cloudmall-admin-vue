<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="name" header-align="center" align="center" label="專题名字"></el-table-column>
      <el-table-column prop="title" header-align="center" align="center" label="專题標题"></el-table-column>
      <el-table-column prop="subTitle" header-align="center" align="center" label="專题副標题"></el-table-column>
      ...
      <el-table-column prop="img" header-align="center" align="center" label="專题圖片地址"></el-table-column>
