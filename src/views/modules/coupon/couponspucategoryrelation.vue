<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="categoryId" header-align="center" align="center" label="產品分類id"></el-table-column>
      <el-table-column prop="categoryName" header-align="center" align="center" label="產品分類名稱"></el-table-column>
